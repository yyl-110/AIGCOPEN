<template>
  <div class="relative wh-full flex flex-col overflow-hidden">
    ...
    <div
      id="scrollRef"
      ref="scrollRef"
      class="box flex-1 overflow-y-auto px-20 lt-sm:min-h-200px lt-sm:px-5"
    >
      <!-- 聊天 -->
    ...
    <div class="bottom relative flex-shrink-0 px-20" style="overflow: initial">
      <div class="lt-lg:gp-8 absolute top--45 z-1 flex gap-16">
        <n-button class="btn w-110 cursor-pointer b-rd-10 bg-#9B9B9B33 text-14" @click="clear">
...
watch(
  ...
  () =>
    nextTick(() => {
      scrollToBottom()
      initPrompt.value = message.value[0]?.content
