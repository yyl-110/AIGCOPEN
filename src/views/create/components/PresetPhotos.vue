  ...
  <n-modal v-model:show="showModal">
    <div class="h-566 w-446 flex flex-col overflow-hidden b-rd-10 bg-#1A1B1E lt-sm:w-full">
      <div class="header h-80 flex items-center justify-center">
        ...
        <div
          class="close absolute right-12 flex cursor-pointer items-center justify-center b-rd-4 bg-#D9D9D933 p-8"
      ...
      <div
        class="nav box-border h-78 w-full flex items-center gap-20 overflow-x-auto px-32 lt-sm:px-10"
      >
        <div
      ...
      <div class="flex-1 overflow-y-auto px-32">
        <n-grid cols="2 s:3 m:3 l:3 xl:3 2xl:3" :x-gap="16" :y-gap="12" responsive="screen">
          <n-grid-item v-for="item in 10">
            <img
              src="https://test.aigcopen.com/icon/abstract/abs_1.png"
              class="w-full b-rd-4"
              alt=""
            />
          </n-grid-item>
